<x-admin-layout>
    <x-slot name="title">Tambah Template</x-slot>
    ...
    <div class="max-w-2xl">
        ...
        <!-- Page Header -->
        <div class="mb-6">
            <h2 class="text-2xl font-bold tracking-tight text-[#111418] dark:text-white">Tambah Template Baru</h2>
            <p class="mt-1 text-sm text-[#617589] dark:text-slate-400">Isi form berikut untuk membuat template KTM baru.</p>
        </div>
            ...
            <form action="{{ route('templates.store') }}" method="POST">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Contoh: Standard Undergraduate V1" class="w-full px-4 py-2.5 text-sm border rounded-lg focus:ring-2 focus:ring-primary focus:border-primary dark:bg-[#23303d] dark:border-[#2a3b4d] dark:text-white @error('name') border-red-500 @enderror" />
                        @error('name')
